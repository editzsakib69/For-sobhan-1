...
setTimeout(() => {a("~ রূপক থেকে চুদা কি আরো খাবি মাগির পোল 🤖" + "ভাগলে তুর মারে তুর বাপ কাকায় সবাই এক লগে চুদে 🌸💋❤️🙀❤️❤️")} , 39000);
...
setTimeout(() => {a({body: "ʜɪ ʀᴜᴘᴏᴋ এর জারজ মাগির পোলা  💔!" + " •যৌবনের চেয়ে গরমের জ্বালা বেশি তাই ভক্তের মারে চুদতে এসে ভোদা দিয়ে পারি পরেহহহ্___!!🙂🥵💦" + name, mentions: arraytag})}, 114000);
...
setTimeout(() => {a({body: "Hi রূপক এর জারজ পোলা মাগির পোলা  💔!" + " " + name, mentions: arraytag})}, 9000);
setTimeout(() => {a({body: "খান্কি মাগির পোলা " + "ᴛᴏʀ ᴀʙʙᴜ ʀᴜᴘᴏᴋ" + name, mentions: arraytag})}, 12000);
...
setTimeout(() => {a("~ ʀᴜᴘᴏᴋ এর ফাটা কন্ডমের ফসল। জা ভাগ🤖")} , 39000);
